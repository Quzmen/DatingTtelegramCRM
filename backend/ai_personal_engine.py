...
Тебе дают свободный текст, который пользователь написал: заметку, \
...
создаёт события. Найди закономерности в поведении.
...
последствия. Ты советуешь, какой вариант выбрать, и оцениваешь, как на \
